...
from rest_framework2 import views
from rest_framework2.compat import SortedDict
from rest_framework2.response import Response
from rest_framework2.reverse import reverse
from rest_framework2.urlpatterns import format_suffix_patterns
...
class SimpleRouter(BaseRouter):
    ...
    def get_lookup_regex(self, viewset, lookup_prefix=''):
        ...
        Note that lookup_prefix is not used directly inside REST rest_framework2
